...
class ExperimentConfig:
    ...
    tracking_uri: Optional[str] = None  # None = use local default
...
class MLflowTracker:
    ...
    async def log_generation(self, metrics: GenerationMetrics, image_path: Optional[Path] = None) -> None:
    ...
    async def log_artifact(self, local_path: Path, artifact_path: Optional[str] = None) -> None:
    ...
    async def _flush_params(self) -> None:
        ...
        try:
            ...
            for item in batch:
                ...
                await loop.run_in_executor(
                    None,
                    lambda: mlflow.log_params(params, run_id=run_id),
                )
    ...
    async def _flush_metrics(self) -> None:
        ...
        try:
            ...
            for item in batch:
                ...
                await loop.run_in_executor(
                    None,
                    lambda: mlflow.log_metrics(metrics, step=step, run_id=run_id),
                )
