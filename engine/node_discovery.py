...
class NodeDiscovery:
    ...
    def _find_comfyui(self) -> Optional[Path]:
    ...
    async def _analyze_node_directory(self, path: Path) -> Optional[NodeInfo]:
    ...
    async def _analyze_node_file(self, path: Path) -> Optional[NodeInfo]:
