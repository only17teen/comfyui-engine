...
try:
    from opentelemetry import metrics as _otel; _OTEL = True
except ImportError:
    _OTEL = False
...
class MetricsRegistry:
    ...
    def request_counter(self) -> Any: return self._c("http.server.request_count","Total HTTP requests")
    def error_counter(self) -> Any: return self._c("app.error_count","Total errors")
    def cache_hit_counter(self) -> Any: return self._c("app.cache.hit_count","Cache hits")
    def cache_miss_counter(self) -> Any: return self._c("app.cache.miss_count","Cache misses")
    def request_duration(self) -> Any: return self._h("http.server.duration","ms","HTTP duration")
    def queue_processing_time(self) -> Any: return self._h("app.queue.processing_time","ms","Queue duration")
    def command_duration(self) -> Any: return self._h("command.duration_ms","ms","Command duration")
    ...
    def get_gauge_snapshot(self) -> dict[str, float]: return dict(self._gauge)
